    ...
    for i in contours:
      ...
      if M['m00'] != 0:
          ...
          if(w/h < 1.9 and w/h > 0.98 and w < 35):
            if(ratio > 0.66 and w*h < 700 and w*h > 200):# empty hole
              cv2.rectangle(frame, (x,y), (x+w,y+h), (255, 255, 0), 2)
              cv2.putText(frame, "empty", (cx - 50, cy - 10),
                      cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0), 1)
            elif (ratio < 0.9 and ratio > 0.3 and w > 15 and h > 15 and w*h >= 700):# sticker placed
          ...
          elif(w/h < 0.8  and w/h > 0.2 and ratio > 0.3 and ratio < 0.9 and w > 10 and h > 20 and w < 20 and h < 45):#filled side hole special case
              cv2.rectangle(frame, (x,y), (x+w,y+h), (0, 255, 0), 2)
              cv2.putText(frame, "side hole", (x - 20, y - 20),
                      cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0), 2)
          elif(w*h > 1000 and ratio > 0.5 and ratio < 0.8 and w > 10 and h > 10):# misplaced
